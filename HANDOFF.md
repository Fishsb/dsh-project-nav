...
_本文件应随项目推进持续更新。最后更新：2026-09-10T13:25Z（两仓提交与推送完成；shoucang 已重装待重启；记录 Set-Content BOM 陷阱）_
